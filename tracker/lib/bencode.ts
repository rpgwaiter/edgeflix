// Original: https://github.com/webtorrent/node-bencode/blob/master/lib/encode.js
// I needed a version of this that didn't require node
...
export function encode (data, buffer?: Buffer, offset?) {
  const buffers = []
  let result = null
